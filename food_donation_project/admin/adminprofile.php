...
<body>
    ...
    <section class="dashboard">
        ...
        <br>
        <br>
        <div style="font-size: larger; width: 30%; margin: 0 auto; border: 1px solid #ccc; border-radius: 10px; box-shadow: 2px 2px 5px #888888;">
            <br>
            <div style="margin-left: 29%;">
                <p class="mb-2"><b>Name:</b> <?php echo "" . $_SESSION['name']; ?></p>
                <p class="mb-2"><b>Email:</b> <?php echo "" . $_SESSION['email']; ?></p>
                <p class="mb-2"><b>District:</b> <?php echo "" . $_SESSION['location']; ?></p>
            </div>
            <br>
        </div>
        ...
        <div class="activity">
            <div class="table-container">
                ...
                <div class="table-wrapper">
                    <br>
                    <p style="text-align:center; font-size:30px;"><b>Donation info</b></p>
                    <table class="table">
                        <thead>
                            <tr class="theader">
                                <th>Name</th>
                ...
                <br>
                <p style="text-align:center; font-size:30px;"><b>User info</b></p>
                ...
                <div>
                    <table>
                        ...
                        <?php
                        $query = "SELECT id, name, email, password, gender FROM login";
